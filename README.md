...
**This is a Helper plugin for the booster events we hold on the 1MoreBlock.com Minecraft 1.21.11 Java server.**
...
updated it slightly, so it works _okay_ with 1.16.5, and mcMMO Overhaul. This now works on 64bit java8, java11 and
java16. The next step is making it a bit more modern, follow the logic of its purpose a bit more. And prepping it for
...
At the moment this supports mcMMO XP Multiplier Rate Events, but I can imagine in the (near) future we could add support
for Jobs-Reborn, PyroWelcomes, Discord, etc.
...
[Tested build](https://github.com/mrfdev/Boosters/releases) Version 1.0.31, for Spigot 1.21.1. Last updated: December
27th 2025.
